...
%s posplošeno verzijo Ramseyevega izreka. 
%
%\begin{trditev}[Erdős-Szekeres 1935] \label{trditev:happyend}
...
%
%Trditev \ref{trditev:happyend} je osnovni rezultat o tako imenovanem 
%``The Happy End Problem''. Več o tem problemu se nahaja v \cite[poglavje 29]{color}.
...
Kljub obstoju tudi boljših ocen od zgornjih, %tistih iz prejšnjega razdelka, pa 
...
\begin{thebibliography}{99}
    ...
    \bibitem{r333} https://upload.wikimedia.org/wikipedia/commons/5/51/K\_16\_partitioned\_into\_three\_Clebsch\_graphs.svg, pridobljeneno 29.~1.~2025.
    \bibitem{wiki} \emph{Ramsey's theorem}, Wipedia, https://en.wikipedia.org/wiki/Ramsey's\_theorem, pridobljeno: 28.~1.~2025.
\end{thebibliography}
