...
\usepackage{graphicx}
\usepackage[frame,enotno]{matrika}
...
\begin{thebibliography}{99}
    ...
    \bibitem{wiki} \emph{Ramsey's theorem}, Wikipedia, Spletna stran: https://en.wikipedia.org/wiki/Ramsey's\_theorem, ogled: 28.~1.~2025.
\end{thebibliography}
